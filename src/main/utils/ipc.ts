...
export function registerIpcMainHandlers(): void {
  ...
  ipcMain.handle('mihomoCloseConnection', (_e, id) =>
    ipcErrorWrapper(mihomoCloseConnection)(id),
  )
  ipcMain.handle(
    'mihomoCloseAllConnections',
    ipcErrorWrapper(mihomoCloseAllConnections),
  )
  ...
  ipcMain.handle('mihomoUnfixedProxy', (_e, group) =>
    ipcErrorWrapper(mihomoUnfixedProxy)(group),
  )
  ...
  ipcMain.handle('patchMihomoConfig', (_e, patch) =>
    ipcErrorWrapper(patchMihomoConfig)(patch),
  )
  ...
  ipcMain.handle('getAppConfig', (_e, force) =>
    ipcErrorWrapper(getAppConfig)(force),
  )
  ipcMain.handle('patchAppConfig', (_e, config) =>
    ipcErrorWrapper(patchAppConfig)(config),
  )
  ...
  ipcMain.handle('getProfileConfig', (_e, force) =>
    ipcErrorWrapper(getProfileConfig)(force),
  )
  ipcMain.handle('setProfileConfig', (_e, config) =>
    ipcErrorWrapper(setProfileConfig)(config),
  )
  ipcMain.handle(
    'getCurrentProfileItem',
    ipcErrorWrapper(getCurrentProfileItem),
  )
  ipcMain.handle('getProfileItem', (_e, id) =>
    ipcErrorWrapper(getProfileItem)(id),
  )
  ipcMain.handle('getProfileStr', (_e, id) =>
    ipcErrorWrapper(getProfileStr)(id),
  )
  ipcMain.handle('getFileStr', (_e, path) => ipcErrorWrapper(getFileStr)(path))
  ipcMain.handle('setFileStr', (_e, path, str) =>
    ipcErrorWrapper(setFileStr)(path, str),
  )
  ipcMain.handle('setProfileStr', (_e, id, str) =>
    ipcErrorWrapper(setProfileStr)(id, str),
  )
  ipcMain.handle('updateProfileItem', (_e, item) =>
    ipcErrorWrapper(updateProfileItem)(item),
  )
  ipcMain.handle('changeCurrentProfile', (_e, id) =>
    ipcErrorWrapper(changeCurrentProfile)(id),
  )
  ipcMain.handle('addProfileItem', (_e, item) =>
    ipcErrorWrapper(addProfileItem)(item),
  )
  ipcMain.handle('removeProfileItem', (_e, id) =>
    ipcErrorWrapper(removeProfileItem)(id),
  )
  ipcMain.handle('getOverrideConfig', (_e, force) =>
    ipcErrorWrapper(getOverrideConfig)(force),
  )
  ipcMain.handle('setOverrideConfig', (_e, config) =>
    ipcErrorWrapper(setOverrideConfig)(config),
  )
  ipcMain.handle('getOverrideItem', (_e, id) =>
    ipcErrorWrapper(getOverrideItem)(id),
  )
  ipcMain.handle('addOverrideItem', (_e, item) =>
    ipcErrorWrapper(addOverrideItem)(item),
  )
  ipcMain.handle('removeOverrideItem', (_e, id) =>
    ipcErrorWrapper(removeOverrideItem)(id),
  )
  ipcMain.handle('updateOverrideItem', (_e, item) =>
    ipcErrorWrapper(updateOverrideItem)(item),
  )
  ipcMain.handle('getOverride', (_e, id, ext) =>
    ipcErrorWrapper(getOverride)(id, ext),
  )
  ipcMain.handle('setOverride', (_e, id, ext, str) =>
    ipcErrorWrapper(setOverride)(id, ext, str),
  )
  ipcMain.handle('restartCore', ipcErrorWrapper(restartCore))
  ipcMain.handle('startMonitor', (_e, detached) =>
    ipcErrorWrapper(startMonitor)(detached),
  )
  ipcMain.handle('triggerSysProxy', (_e, enable) =>
    ipcErrorWrapper(triggerSysProxy)(enable),
  )
  ...
  ipcMain.handle('readTextFile', (_e, filePath) =>
    ipcErrorWrapper(readTextFile)(filePath),
  )
  ...
  ipcMain.handle('webdavRestore', (_e, filename) =>
    ipcErrorWrapper(webdavRestore)(filename),
  )
  ipcMain.handle('listWebdavBackups', ipcErrorWrapper(listWebdavBackups))
  ipcMain.handle('webdavDelete', (_e, filename) =>
    ipcErrorWrapper(webdavDelete)(filename),
  )
